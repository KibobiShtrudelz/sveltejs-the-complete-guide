...
var app = (function () {
    ...
    /* src\Cart\CartItem.svelte generated by Svelte v3.58.0 */
    const file$4 = "src\\Cart\\CartItem.svelte";

    // (45:2) <Button mode="outline" on:click={displayDescription}>
    function create_default_slot_1(ctx) {
    	let t_value = (/*isDescriptionVisible*/ ctx[2]
    	? 'Hide Description'
    	: 'Show Description') + "";
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*isDescriptionVisible*/ 4 && t_value !== (t_value = (/*isDescriptionVisible*/ ctx[2]
    			? 'Hide Description'
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(45:2) <Button mode=\\\"outline\\\" on:click={displayDescription}>",
    		ctx
    	});
    ...
    // (49:2) <Button on:click={removeFromCart}>
    function create_default_slot$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(49:2) <Button on:click={removeFromCart}>",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$4, 51, 4, 1265);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(51:2) {#if isDescriptionVisible}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	let if_block = /*isDescriptionVisible*/ ctx[2] && create_if_block$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 40, 2, 993);
    			attr_dev(h2, "class", "svelte-1td7xux");
    			add_location(h2, file$4, 42, 2, 1013);
    			attr_dev(li, "class", "svelte-1td7xux");
    			add_location(li, file$4, 39, 0, 986);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, isDescriptionVisible*/ 132) {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['id', 'title', 'price'];
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('title' in $$props) $$invalidate(0, title = $$props.title);
    		if ('price' in $$props) $$invalidate(1, price = $$props.price);
    		if ('isDescriptionVisible' in $$props) $$invalidate(2, isDescriptionVisible = $$props.isDescriptionVisible);
    ...
    class CartItem extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { id: 6, title: 0, price: 1 });
    ...
    const timerStore = readable(count, set => {
    ...
    /* src\Cart\Cart.svelte generated by Svelte v3.58.0 */
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 32, 6, 633);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    // (30:4) {#each $cartStore as item (item.id)}
    function create_each_block$1(key_1, ctx) {
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*$cartStore*/ 1) cartitem_changes.id = /*item*/ ctx[2].id;
    			if (dirty & /*$cartStore*/ 1) cartitem_changes.title = /*item*/ ctx[2].title;
    			if (dirty & /*$cartStore*/ 1) cartitem_changes.price = /*item*/ ctx[2].price;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(30:4) {#each $cartStore as item (item.id)}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	let current;
    	let each_value = /*$cartStore*/ ctx[0];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 26, 2, 482);
    			attr_dev(ul, "class", "svelte-1c2znv1");
    			add_location(ul, file$3, 28, 2, 499);
    			attr_dev(section, "class", "svelte-1c2znv1");
    			add_location(section, file$3, 25, 0, 470);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	let $cartStore;
    	validate_store(cartStore, 'cartStore');
    ...
    /* src\Products\Product.svelte generated by Svelte v3.58.0 */
    const file$2 = "src\\Products\\Product.svelte";

    // (24:4) <Button on:click={addToCart}>
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(24:4) <Button on:click={addToCart}>",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$2, 17, 4, 318);
    			attr_dev(p, "class", "svelte-12wunlm");
    			add_location(p, file$2, 19, 4, 340);
    			add_location(div0, file$2, 14, 2, 286);
    			add_location(div1, file$2, 22, 2, 373);
    ...
    /* src\Products\Products.svelte generated by Svelte v3.58.0 */
    ...
    // (24:2) {#each $productsStore as product (product.id)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*$productsStore*/ 1) product_changes.id = /*product*/ ctx[1].id;
    			if (dirty & /*$productsStore*/ 1) product_changes.title = /*product*/ ctx[1].title;
    			if (dirty & /*$productsStore*/ 1) product_changes.price = /*product*/ ctx[1].price;
    			if (dirty & /*$productsStore*/ 1) product_changes.description = /*product*/ ctx[1].description;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(24:2) {#each $productsStore as product (product.id)}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	let each_1_lookup = new Map();
    	let current;
    	let each_value = /*$productsStore*/ ctx[0];
    	validate_each_argument(each_value);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 22, 2, 419);
    			attr_dev(section, "class", "svelte-o8blwk");
    			add_location(section, file$1, 21, 0, 407);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*$productsStore*/ 1) {
    				each_value = /*$productsStore*/ ctx[0];
    				validate_each_argument(each_value);
    				group_outros();
    				validate_each_keys(ctx, each_value, get_each_context, get_key);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	let $productsStore;
    	validate_store(productsStore, 'productsStore');
    	component_subscribe($$self, productsStore, $$value => $$invalidate(0, $productsStore = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	$$self.$capture_state = () => ({ Product, productsStore, $productsStore });
    ...
    // (20:0) <Button on:click={() => (isCartVisible = !isCartVisible)}>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(20:0) <Button on:click={() => (isCartVisible = !isCartVisible)}>",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let if_block = /*isCartVisible*/ ctx[0] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			p = element("p");
    			t3 = text("Count: ");
    			t4 = text(/*$timerStore*/ ctx[1]);
    			add_location(p, file, 27, 0, 557);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (/*isCartVisible*/ ctx[0]) {
    				if (if_block) {
    					if (dirty & /*isCartVisible*/ 1) {
    			...
    			if (!current || dirty & /*$timerStore*/ 2) set_data_dev(t4, /*$timerStore*/ ctx[1]);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(button.$$.fragment, local);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, timerStore, $$value => $$invalidate(1, $timerStore = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	const click_handler = () => $$invalidate(0, isCartVisible = !isCartVisible);
    	...
    	$$self.$inject_state = $$props => {
    		if ('isCartVisible' in $$props) $$invalidate(0, isCartVisible = $$props.isCartVisible);
    	};
    	...
    	return [isCartVisible, $timerStore, click_handler];
    }
