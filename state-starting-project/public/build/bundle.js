...
var app = (function () {
    ...
    // (47:2) <Button mode="outline" on:click={displayDescription}>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(47:2) <Button mode=\\\"outline\\\" on:click={displayDescription}>",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 53, 4, 1313);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(53:2) {#if isDescriptionVisible}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 42, 2, 1041);
    			attr_dev(h2, "class", "svelte-1td7xux");
    			add_location(h2, file$3, 44, 2, 1061);
    			attr_dev(li, "class", "svelte-1td7xux");
    			add_location(li, file$3, 41, 0, 1034);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 27, 6, 508);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    // (25:4) {#each $cartStore as item (item.id)}
    function create_each_block$1(key_1, ctx) {
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*$cartStore*/ 1) cartitem_changes.id = /*item*/ ctx[1].id;
    			if (dirty & /*$cartStore*/ 1) cartitem_changes.title = /*item*/ ctx[1].title;
    			if (dirty & /*$cartStore*/ 1) cartitem_changes.price = /*item*/ ctx[1].price;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(25:4) {#each $cartStore as item (item.id)}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 21, 2, 357);
    			attr_dev(ul, "class", "svelte-1c2znv1");
    			add_location(ul, file$2, 23, 2, 374);
    			attr_dev(section, "class", "svelte-1c2znv1");
    			add_location(section, file$2, 20, 0, 345);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (33:4) <Button on:click={addToCart}>
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(33:4) <Button on:click={addToCart}>",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 24, 4, 393);
    			attr_dev(h2, "class", "svelte-9ht2za");
    			add_location(h2, file$1, 26, 4, 415);
    			attr_dev(p, "class", "svelte-9ht2za");
    			add_location(p, file$1, 28, 4, 437);
    			add_location(div0, file$1, 23, 2, 383);
    			add_location(div1, file$1, 31, 2, 470);
    			attr_dev(div2, "class", "product svelte-9ht2za");
    			add_location(div2, file$1, 22, 0, 359);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	function addToCart() {
    		cartStore.update(currentCartStore => [...currentCartStore, { id, title, price }]);
    	}
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 22, 2, 419);
    			attr_dev(section, "class", "svelte-o8blwk");
    			add_location(section, file, 21, 0, 407);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (9:0) <Button on:click={() => (isCartVisible = !isCartVisible)}>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(9:0) <Button on:click={() => (isCartVisible = !isCartVisible)}>",
    		ctx
    	});
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Cart, Button, Products, isCartVisible });
    	...
    	return [isCartVisible, click_handler];
    }
